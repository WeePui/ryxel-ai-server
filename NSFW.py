...
if __name__ == "__main__":
    ...
    detections = detect_nsfw(image_path)
    for detection in detections:
        print(f"Found: {detection['class']}, Score: {detection['score']}")
